...
//        String fileType = "png";
        ...
        try {
            ...
            hintMap.put(EncodeHintType.ERROR_CORRECTION, ErrorCorrectionLevel.L);
            QRCodeWriter qrCodeWriter = new QRCodeWriter();
            BitMatrix byteMatrix = qrCodeWriter.encode(code,BarcodeFormat.QR_CODE, width, height, hintMap);
            ...
            int x = 40;
            graphics.drawString(amostra, x, 10);
            graphics.drawString(fap, x, 20);
            graphics.drawString(codOrder, x, 30);
            ...
            image = ImageIO.read( new File(myFile.getAbsolutePath()));
